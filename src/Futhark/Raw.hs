...
data Futhark_i64_2d
foreign import ccall unsafe "futhark_new_i64_2d"
  new_i64_2d
    :: Ptr Futhark_context
    -> Ptr Int64
    -> Int64
    -> Int64
    -> IO (Ptr Futhark_i64_2d)

foreign import ccall unsafe "futhark_new_raw_i64_2d"
  new_raw_i64_2d
    :: Ptr Futhark_context
    -> DevicePtr ()
    -> Int64
...
foreign import ccall unsafe "futhark_free_i64_2d"
  free_i64_2d
    :: Ptr Futhark_context
    -> Ptr Futhark_i64_2d
    -> IO Int

foreign import ccall unsafe "futhark_values_i64_2d"
  values_i64_2d
    :: Ptr Futhark_context
    -> Ptr Futhark_i64_2d
    -> Ptr Int64
...
foreign import ccall unsafe "futhark_values_raw_i64_2d"
  values_raw_i64_2d
    :: Ptr Futhark_context
    -> Ptr Futhark_i64_2d
    -> IO (DevicePtr ())

foreign import ccall unsafe "futhark_shape_i64_2d"
  shape_i64_2d
    :: Ptr Futhark_context
    -> Ptr Futhark_i64_2d
    -> IO (Ptr Int64)
...
--Opaque values
--Entry points
foreign import ccall unsafe "futhark_entry_searchUvTreeImage"
  entry_searchUvTreeImage
    :: Ptr Futhark_context
    -> Ptr (Ptr Futhark_f32_2d)
    -> Ptr (Ptr Futhark_i64_2d)
    -> Ptr Futhark_f32_3d
    -> Ptr Futhark_f32_2d
    -> IO Int

foreign import ccall unsafe "futhark_entry_searchUvTreeXYPresence"
  entry_searchUvTreeXYPresence
    :: Ptr Futhark_context
    -> Ptr (Ptr Futhark_i64_2d)
    -> Float
    -> Ptr Futhark_f32_3d
...
foreign import ccall unsafe "futhark_entry_testNodeBox"
  entry_testNodeBox
    :: Ptr Futhark_context
    -> Ptr (Ptr Futhark_i64_2d)
    -> Int64
...
foreign import ccall unsafe "futhark_entry_testTreeBox"
  entry_testTreeBox
    :: Ptr Futhark_context
    -> Ptr (Ptr Futhark_i64_2d)
    -> Int64
...
foreign import ccall unsafe "futhark_entry_verifyRectFrame"
  entry_verifyRectFrame
    :: Ptr Futhark_context
...
foreign import ccall unsafe "futhark_entry_verifyUvGradientFrame"
  entry_verifyUvGradientFrame
    :: Ptr Futhark_context
...
foreign import ccall unsafe "futhark_entry_verifyUvImageOut"
  entry_verifyUvImageOut
    :: Ptr Futhark_context
    -> Ptr (Ptr Futhark_f32_3d)
    -> Ptr (Ptr Futhark_f32_3d)
    -> Ptr Futhark_f32_3d
...
foreign import ccall unsafe "futhark_entry_verifyYxUvSearch"
  entry_verifyYxUvSearch
    :: Ptr Futhark_context
    -> Ptr (Ptr Futhark_f32_3d)
    -> Ptr Futhark_f32_3d
    -> IO Int
